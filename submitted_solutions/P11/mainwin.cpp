...
Mainwin::Mainwin(Shelter& shelter) : shelter{&shelter} 
{
	...
	/*
	// Open Default File
	Gtk::MenuItem *menuitem_opendefault = Gtk::manage(new Gtk::MenuItem("_Open Default", true));
	menuitem_opendefault->signal_activate().connect([this] {this->on_open_click();});
	filemenu->append(*menuitem_opendefault);
	*/

	/*
	// Save to Specified File option
	Gtk::MenuItem *menuitem_savespec = Gtk::manage(new Gtk::MenuItem("_Save", true));
	menuitem_savespec->signal_activate().connect([this] {this->on_save_as_click();});
	filemenu->append(*menuitem_savespec);

	// Open Default File
	Gtk::MenuItem *menuitem_openspec = Gtk::manage(new Gtk::MenuItem("_Open Default", true));
	menuitem_openspec->signal_activate().connect([this] {this->on_open_click();});
	filemenu->append(*menuitem_openspec);
	*/
	...
	// About
	Gtk::MenuItem *menuitem_about = Gtk::manage(new Gtk::MenuItem("_New Shelter", true));
	...
	*/
    ...
    /*
    // View Animal option
    Gtk::MenuItem *menuitem_view = Gtk::manage(new Gtk::MenuItem("_Adopt", true));
    menuitem_view->signal_activate().connect([this] {this->on_view_animal_click();});
...
void Mainwin::on_open_click()
{
    try 
    {
        std::ifstream ifs{"untitled.ctp"};
        shelter->load(ifs);
    }
    catch (std::exception& e) 
    {
        Gtk::MessageDialog{*this, "Unable to open file", false, Gtk::MESSAGE_ERROR}.run();
    }
}
